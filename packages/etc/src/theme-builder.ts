...
const palettes = {
  ...
  "light": ['hsla(227, 58%, 65%, 1)', 'hsla(0, 0%, 99%, 0)', 'hsla(0, 0%, 99%, 0.25)', 'hsla(0, 0%, 99%, 0.5)', 'hsla(0, 0%, 99%, 0.75)', 'hsla(0, 0%, 99%, 1)', 'hsla(0, 0%, 93%, 1)', 'hsla(0, 0%, 88%, 1)', 'hsla(0, 0%, 82%, 1)', 'hsla(0, 0%, 77%, 1)', 'hsla(0, 0%, 72%, 1)', 'hsla(0, 0%, 66%, 1)', 'hsla(0, 0%, 61%, 1)', 'hsla(0, 0%, 55%, 1)', 'hsla(0, 0%, 50%, 1)', 'hsla(0, 15%, 15%, 1)', 'hsla(0, 15%, 10%, 1)', 'hsla(0, 14%, 10%, 0.75)', 'hsla(0, 14%, 10%, 0.5)', 'hsla(0, 14%, 10%, 0.25)', 'hsla(0, 14%, 10%, 0)', 'hsla(227, 58%, 65%, 1)']
  ,
  "dark": ['hsla(227, 58%, 58%, 1)', 'hsla(0, 0%, 15%, 0)', 'hsla(0, 0%, 15%, 0.25)', 'hsla(0, 0%, 15%, 0.5)', 'hsla(0, 0%, 15%, 0.75)', 'hsla(0, 0%, 15%, 1)', 'hsla(0, 0%, 19%, 1)', 'hsla(0, 0%, 23%, 1)', 'hsla(0, 0%, 27%, 1)', 'hsla(0, 0%, 31%, 1)', 'hsla(0, 0%, 34%, 1)', 'hsla(0, 0%, 38%, 1)', 'hsla(0, 0%, 42%, 1)', 'hsla(0, 0%, 46%, 1)', 'hsla(0, 0%, 50%, 1)', 'hsla(0, 15%, 93%, 1)', 'hsla(0, 15%, 95%, 1)', 'hsla(0, 15%, 95%, 0.75)', 'hsla(0, 15%, 95%, 0.5)', 'hsla(0, 15%, 95%, 0.25)', 'hsla(0, 15%, 95%, 0)', 'hsla(227, 58%, 49%, 1)']
  ,
  "light_accent": ['hsla(0, 0%, 82%, 1)', 'hsla(227, 58%, 65%, 0)', 'hsla(227, 58%, 65%, 0.25)', 'hsla(227, 58%, 65%, 0.5)', 'hsla(227, 58%, 65%, 0.75)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(227, 58%, 65%, 1)', 'hsla(250, 50%, 95%, 1)', 'hsla(250, 50%, 95%, 1)', 'hsla(249, 52%, 95%, 0.75)', 'hsla(249, 52%, 95%, 0.5)', 'hsla(249, 52%, 95%, 0.25)', 'hsla(249, 52%, 95%, 0)', 'hsla(0, 0%, 55%, 1)']
  ,
  "dark_accent": ['hsla(0, 0%, 46%, 1)', 'hsla(227, 58%, 43%, 0)', 'hsla(227, 58%, 43%, 0.25)', 'hsla(227, 58%, 43%, 0.5)', 'hsla(227, 58%, 43%, 0.75)', 'hsla(227, 58%, 43%, 1)', 'hsla(227, 58%, 45%, 1)', 'hsla(227, 58%, 47%, 1)', 'hsla(227, 58%, 49%, 1)', 'hsla(227, 58%, 51%, 1)', 'hsla(227, 58%, 52%, 1)', 'hsla(227, 58%, 54%, 1)', 'hsla(227, 58%, 56%, 1)', 'hsla(227, 58%, 58%, 1)', 'hsla(227, 58%, 60%, 1)', 'hsla(250, 50%, 90%, 1)', 'hsla(250, 50%, 95%, 1)', 'hsla(249, 52%, 95%, 0.75)', 'hsla(249, 52%, 95%, 0.5)', 'hsla(249, 52%, 95%, 0.25)', 'hsla(249, 52%, 95%, 0)', 'hsla(0, 0%, 27%, 1)']
